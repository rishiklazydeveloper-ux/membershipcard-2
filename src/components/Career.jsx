...
function Career() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      setStatus({ type: 'success', msg: 'Your form has been submitted, we will connect with you as soon as possible.' })
      setTimeout(() => {
        setShowModal(false)
      ...
      <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 40px', boxSizing: 'border-box' }}>
        ...
        <div style={{ marginTop: '28px', display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '16px' }} className="career-camp">
          <div style={{ background: '#0e2328', borderRadius: '16px', padding: '28px', color: '#fff', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ marginTop: '20px', display: 'inline-flex', alignItems: 'center', gap: '10px', background: '#e6f4ea', color: '#137333', fontSize: '13px', fontWeight: 700, padding: '10px 18px', borderRadius: '9999px', border: '1px solid #b7e1c3' }}>
              Free Entry — No Fee
            </div>
          </div>
