...
function Footer() {
  return (
    <footer id="career" style={{ position: 'relative', overflow: 'hidden', background: '#0e2328' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, maxWidth: '1440px', margin: '0 auto', padding: '60px 40px 0' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr', gap: '40px', alignItems: 'start' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <a href="#top" style={{ color: 'rgba(255,255,255,0.75)', fontSize: '14px', fontWeight: 500, textDecoration: 'none' }}>Home</a>
              ...
              <a href="#career" style={{ color: 'rgba(255,255,255,0.75)', fontSize: '14px', fontWeight: 500, textDecoration: 'none' }}>Career</a>
            </div>
          </div>
        ...
        {/* Bottom thin line */}
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', marginTop: '0', padding: '14px 0 20px', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
          <div style={{ color: 'rgba(255,255,255,0.45)', fontSize: '11px' }}>© 2026 Vita Membership. Tap & Pay Card • ₹5,00,000 / year</div>
